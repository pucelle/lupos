...
const $html_2 = /*#__PURE__*/ new HTMLMaker("<!----><!--c3c117-->");
/*
<root>
    <lu:await ${this.promise} />
</root>
*/ const $template_2 = /*#__PURE__*/ new TemplateMaker(function ($context, $hydrates) {
    ...
    let $node_0 = $locator.childAt(0);
    let $node_1 = $locator.getMarker("c3c117");
    let $slot_0 = new TemplateSlot(new SlotPosition(1, $node_1), null, $locator.getNodes("c3c117"));
...
const $html_4 = /*#__PURE__*/ new HTMLMaker("<!----><!--ed876a-->");
/*
<root>
    <lu:await ${this.promise} />
</root>
