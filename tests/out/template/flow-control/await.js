import { Component, html, TemplateMaker, SlotPosition, AwaitBlock, TemplateSlot, HTMLMaker } from '@pucelle/lupos.js';
...
const $template_0 = new TemplateMaker($context => {
    ...
    $block_0 = new AwaitBlock([$template_1, $template_2, null], new TemplateSlot(new SlotPosition(2, $node_1), $context), $context);
    return {
        el: $node,
...
const $template_3 = new TemplateMaker($context => {
    ...
    let $node_0 = $node.content.firstChild;
    let $node_1 = $node.content.lastChild;
    $block_0 = new AwaitBlock([$template_4, null, $template_5], new TemplateSlot(new SlotPosition(2, $node_1), $context), $context);
    return {
        el: $node,
        position: new SlotPosition(2, $node_0),
        update($values) {
...
const $template_6 = new TemplateMaker($context => {
    ...
    let $node_0 = $node.content.firstChild;
    let $node_1 = $node.content.lastChild;
    $block_0 = new AwaitBlock([$template_7, $template_8, $template_9], new TemplateSlot(new SlotPosition(2, $node_1), $context), $context);
    return {
        el: $node,
        position: new SlotPosition(2, $node_0),
        update($values) {
