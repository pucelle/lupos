import { Component, html, TemplateMaker, SlotPosition, SwitchBlock, TemplateSlot, HTMLMaker } from '@pucelle/lupos.js';
...
const $template_0 = new TemplateMaker($context => {
    ...
    }, [$template_1, $template_2], new TemplateSlot(new SlotPosition(2, $node_1), $context), $context);
    return {
        el: $node,
...
const $template_3 = new TemplateMaker($context => {
    ...
    }, [$template_4, $template_5, $template_6], new TemplateSlot(new SlotPosition(2, $node_1), $context), $context);
    return {
        el: $node,
        position: new SlotPosition(2, $node_0),
        update($values) {
