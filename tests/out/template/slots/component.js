...
const $html_1 = /*#__PURE__*/ new HTMLMaker("<div com><!--ebdfad-->Rest Content</div>");
/*
<root>
    <ChildComponent>
        Rest Content
...
*/ const $template_1 = /*#__PURE__*/ new TemplateMaker(function (_$context, $hydrates) {
    ...
    let $node_0 = $locator.childAt(0);
    let $node_1 = $locator.getMarker("ebdfad");
...
const $html_2 = /*#__PURE__*/ new HTMLMaker("<div com><!--224cc1--><!--1a79a9-->Rest Content</div>");
/*
<root>
    <ChildComponent>
        ${html`<div />`}
...
*/ const $template_2 = /*#__PURE__*/ new TemplateMaker(function ($context, $hydrates) {
    ...
    let $node_0 = $locator.childAt(0);
    let $node_1 = $locator.getMarker("224cc1");
    let $node_2 = $locator.getMarker("1a79a9");
    let $node_3 = $node_2.nextSibling;
    let $com_0 = new ChildComponent($node_0);
    let $slot_0 = new TemplateSlot(new SlotPosition(1, $node_2), 0, $locator.getNodes("1a79a9"));
