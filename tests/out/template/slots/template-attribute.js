...
const $html_4 = /*#__PURE__*/ new HTMLMaker("<div><!--375ea252--></div>");
/*
<root>
    <template attr="value">
        <div attr=${'value'}>
...
*/ const $template_4 = /*#__PURE__*/ new TemplateMaker(function ($context, $hydrates) {
    ...
    let $node_2 = $locator.getMarker("375ea252");
    let $slot_0 = new TemplateSlot(new SlotPosition(1, $node_2), 0, $locator.getNodes("375ea252"));
    $node_0.setAttribute("attr", "value");
