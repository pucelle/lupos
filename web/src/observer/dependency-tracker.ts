...
/** 
 * When need to track getting of all properties and descendant properties recursively,
 * e.g., when uses `JSON.stringify(...)`.
 * Note you this api can't be generated by compiler, you must call it manually.
 */
